...
public partial class adminpanel_default : System.Web.UI.Page
{
    ...
    protected void cmdSign_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!c.IsRecordExist("Select userId From UsersCLahane Where userName='" + txtUserName.Text + "'"))
            {
            ...
            else if (c.GetReqData("UsersCLahane", "userPwd", "userName='" + txtUserName.Text.Trim() + "'").ToString() != txtPwd.Text)
            {
