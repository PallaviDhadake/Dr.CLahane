<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="testimonials-details.aspx.cs" Inherits="adminpanel_Default2" %>
			...
			<div class="card-body">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						<asp:TextBox ID="txtPersonNm" runat="server" CssClass="form-control" Width="100%" MaxLength="50"></asp:TextBox>
					</div>
					...
					<div class="form-group col-md-6">
					 ...
					 <div class="form-group col-md-6">
					  ...
					  <div class="form-group col-md-6">
						...
						<asp:TextBox ID="txtMobNo" runat="server" CssClass="form-control" Width="100%" 
